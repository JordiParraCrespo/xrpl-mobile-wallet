...
/**
 * The Drops typefaces, loaded at runtime. The showcase runs in Expo Go, which
 * can't use the `expo-font` config plugin (native embedding), so loading here
 * is how the fonts become available.
 *
