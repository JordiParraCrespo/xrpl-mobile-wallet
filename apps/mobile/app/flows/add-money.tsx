...
import { AddMoneyQuickAmounts } from '../../components/flows/add-money-quick-amounts';
 ...
 * plainly. Presented as a full-screen dark route pushed over the hub.
 */
export default function AddMoneyScreen() {
  ...
  return (
    <FlowScreen>
      ...
      <View className="px-2 pb-3.5">
        <AddMoneyQuickAmounts amount={amount} onSelect={setAmount} />
      </View>
