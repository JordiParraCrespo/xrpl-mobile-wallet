...
const DESTINATION = 'To XRP Ledger · $744.87';
...
export default function AddMoneyScreen() {
  ...
  return (
    <FlowScreen>
      <View className="px-4">
        <FlowHeader title="Add money" subtitle={DESTINATION} onBack={() => router.back()} />
      </View>

      <AddMoneyAmount amount={amount} sourceLabel={FUNDING_SOURCE} />

      <AddMoneySubmit disabled={value <= 0} onPress={() => {}} />
