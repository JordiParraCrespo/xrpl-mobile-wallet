...
export class AuthController {
  ...
  @ApiResponse({ status: 200 })
  @ApiResponse({ status: 401, description: 'AUTH_002: Invalid credentials' })
  changePassword(@CurrentUser('sub') userId: string, @Body() body: ChangePasswordRequest) {
    return this.changePasswordService.execute(userId, body.currentPassword, body.newPassword);
  }
